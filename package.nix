...
buildNpmPackage (finalAttrs: {
  ...
  # published @earendil-works/pi-ai npm package, which ships the hydrated
  # catalog under dist/providers/data/. Bump this hash alongside version.
  modelData = fetchurl {
  ...
  # requires network access; the model catalog it would produce is supplied via
  # modelData above.
  buildPhase = ''
    runHook preBuild
